...
// Renseignez information récupéré depuis le back-office Vision à cet endroit
$pbx_site = '1999887';		// Numéro de site
$pbx_rang = '32';		// Numéro de rang
$pbx_identifiant = '215';	// Identifiant de site
$pbx_total = '199';		// Montant de la commande

// Suppression des points ou virgules dans le montant						
$pbx_total = str_replace(",", "", $pbx_total);
$pbx_total = str_replace(".", "", $pbx_total);

$pbx_cmd = '123';			// Numéro de commande		
$pbx_porteur = 'test@example.com';	// Email de l'acheteur

// Nombre de produit envoyé dans PBX_SHOPPINGCART :
$pbx_nb_produit = '1';	// Nombre de produits dans le panier
...
// Vérification du montant maximal pour l'exemption 3DS
if($pbx_total > 3000) {
...
// Activation de l'univers de production
$serveurs = array(
	'tpeweb.e-transactions.fr', // principale
	'tpeweb1.e-transactions.fr' // secondaire
);

// Activation de l'univers de recette
$serveurs = array('recette-tpeweb.e-transactions.fr');
...
//Renseignez votre clé HMAC récupéré depuis le back-office Vision à cet endroit
...
<form method="POST" action="<?php echo $urletrans; ?>" target="iframePayment">
